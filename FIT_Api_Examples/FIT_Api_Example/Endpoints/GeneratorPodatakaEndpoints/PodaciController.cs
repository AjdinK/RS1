...
namespace FIT_Api_Example.Endpoints.GeneratorPodatakaEndpoints;
...
public class PodaciController : ControllerBase
{
    ...
    public ActionResult Generisi()
    {
        ...
        var opstine = new List<Data.Models.Opstina>();
        ...
        nastavnici.Add(new Nastavnik { Is2FActive = true, Ime = "Denis", Prezime = "Music", KorisnickoIme = "denis", Lozinka = "test", SlikaKorisnika = Config.SlikeURL + "empty.png", });
